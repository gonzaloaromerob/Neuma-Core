...
## Estado
**Reemplazada por ADR-010** desde el 21 de agosto de 2026 para trabajo nuevo. Se conserva únicamente como registro histórico de la política validada durante el piloto.
...
## Evolución posterior
ADR-010 eliminó la necesidad de proyección GitHub → Notion. El estado operacional versionable se consolidó directamente en GitHub; SharePoint conserva la superficie documental humana y los originales internos. **Notion fue retirado completamente de NEUMA el 21 de agosto de 2026.**

Por tanto:
- no crear proyecciones GitHub → Notion;
- no mantener sincronización bidireccional;
- no tratar Notion como postcondición;
- no crear nuevos objetos NEUMA en Notion;
...
El 2026-08-18 se demostró idempotencia con ADR-002 y se detectó/compensó una divergencia deliberada en Notion sin modificar el canónico. Esa evidencia motivó posteriormente la simplificación de arquitectura formalizada en ADR-010 y culminó con el retiro total de Notion.