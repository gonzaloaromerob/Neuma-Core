...
7. **Release Candidate** — **declarado el 2026-08-20 mediante Gate humano explícito**, manteniendo Operations v3.8 estable y los tres módulos en v0.2-pilot. El candidato queda congelado salvo hallazgo material.
8. **Release v4 canónica** — pendiente; publicación versionada mediante Gate C explícito y reconciliación de proyecciones gobernadas.
9. **PROD** — pendiente y separado; desplegar únicamente donde aplique y con Gate C adicional si existe efecto productivo; verificar postcondición y rollback.
...
- Publicación de release v4 canónica — **pendiente**.
- Despliegue a PROD cuando exista efecto productivo — **pendiente y separado**.
