...
1. **NEUMA 3.0 — Manual de Gobierno**: documento rector e integrador del marco. Actualmente clasificado como uso interno/borrador de trabajo hasta su aprobación formal.
2. **NEUMA 3.0 — Anexos Operativos**: contiene, entre otros, Constitución Operativa y Arquitectura Operativa; desarrolla la aplicación del Manual.
3. **NEUMA — Prompts / continuidad consolidada**: evidencia reciente de decisiones metodológicas y configuración vigente; útil para identificar cambios posteriores que deban reconciliarse con los documentos rectores.
4. **Registros de decisiones y ADR**: documentan decisiones específicas y su trazabilidad.
...
## SharePoint y GitHub
- SharePoint conserva el **corpus interno de trabajo y originales rectores**.
